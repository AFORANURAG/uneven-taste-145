...
} from "./chunk-CEWUU6XQ.js";
import {
  _inheritsLoose
} from "./chunk-SMHYBUCF.js";
import {
  createPopper
} from "./chunk-Y4IHVYHJ.js";
import {
  require_react_dom
...
function useFormControlProvider(props) {
  ...
  const [isFocused, setFocus2] = (0, import_react38.useState)(false);
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react49.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react49.useCallback)(() => {
    var _a2;
...
function useShortcut(props = {}) {
  ...
  (0, import_react51.useEffect)(() => flush, []);
...
var useSafeLayoutEffect3 = isBrowser ? import_react52.useLayoutEffect : import_react52.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-TFWETJDV.mjs
var import_react53 = __toESM(require_react(), 1);
function useCallbackRef3(fn, deps = []) {
  const ref = (0, import_react53.useRef)(fn);
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react55.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react60.useRef)();
...
function useOutsideClick(props) {
  ...
  const stateRef = (0, import_react61.useRef)({
    isPointerDown: false,
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react63.useRef)(null);
  const handlers2 = {
...
function useOptionalPart(partId) {
  const [id, setId] = (0, import_react64.useState)(null);
  const ref = (0, import_react64.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react65.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react65.useCallback)(
    (next) => {
...
var useUpdateEffect2 = (effect2, deps) => {
  const renderCycleRef = (0, import_react68.useRef)(false);
  const effectCycleRef = (0, import_react68.useRef)(false);
...
function useForceUpdate() {
  const unloadingRef = (0, import_react70.useRef)(false);
  const [count, setCount] = (0, import_react70.useState)(0);
  useUnmountEffect(() => {
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react71.useState)(isOpen);
  const [once, setOnce] = (0, import_react71.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react72.useState)(initialState2);
  const callbacks = (0, import_react72.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react73.useState)(false);
  const [valueState, setValueState] = (0, import_react73.useState)(value);
  (0, import_react73.useEffect)(() => setValueState(value), [value]);
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react75.useState)(null);
  const rafId = (0, import_react75.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react76.cloneElement)(child, theming) : (0, import_react76.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const childrenToRender = (0, import_react77.useMemo)(
    () => shouldWrapChildren ? import_react77.Children.map(children, (child, index) => (0, import_jsx_runtime70.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const dividerStyle = (0, import_react78.useMemo)(
    () => getDividerStyles({ spacing, direction }),
    [spacing, direction]
  );
  const hasDivider = !!divider;
  const shouldUseChildren = !shouldWrapChildren && !hasDivider;
  const clones = (0, import_react78.useMemo)(() => {
    const validChildren = getValidChildren(children);
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react78.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime72.jsxs)(import_react78.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime79.jsx)(import_jsx_runtime79.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime79.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime79.jsx)(import_react79.Fragment, { children: chunk.text }, index);
  }) });
}
...
var AspectRatio = forwardRef(function(props, ref) {
  ...
  const child = import_react80.Children.only(children);
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys, setKeys] = (0, import_react82.useState)([]);
  const timeoutRef = (0, import_react82.useRef)();
  const flush = () => {
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
      timeoutRef.current = null;
  ...
  (0, import_react82.useEffect)(() => flush, []);
  function onKeyDown(fn) {
    return (event) => {
      if (event.key === "Backspace") {
        const keysCopy = [...keys];
...
function useEventListeners() {
  ...
  const currentListeners = listeners.current;
  const add = (0, import_react83.useCallback)((el, type, listener, options) => {
...
function useFocusOnShow2(target, options = defaultOptions2) {
  ...
  const autoFocusValue = shouldFocus && visible;
  const autoFocusRef = (0, import_react85.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react85.useRef)(visible);
  useSafeLayoutEffect(() => {
    if (!lastVisibleRef.current && visible) {
      autoFocusRef.current = autoFocusValue;
    }
...
function usePopper(props = {}) {
  ...
  const reference = (0, import_react86.useRef)(null);
  const popper = (0, import_react86.useRef)(null);
...
function useDisclosure2(props = {}) {
  ...
  const uid = (0, import_react87.useId)();
...
function useOutsideClick2(props) {
  ...
  const stateRef = (0, import_react88.useRef)({
    isPointerDown: false,
    ignoreEmulatedMouseEvents: false
  });
  const state = stateRef.current;
...
function useAnimationState2(props) {
  ...
  const [once, setOnce] = (0, import_react89.useState)(false);
...
function useMenu(props = {}) {
  ...
  const focusMenu = (0, import_react90.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a2;
      (_a2 = menuRef.current) == null ? void 0 : _a2.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react90.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react90.useCallback)(() => {
    const id2 = setTimeout(() => {
      const last = descendants.lastEnabled();
      if (last)
  ...
  const onOpenInternal = (0, import_react90.useCallback)(() => {
  ...
  const openAndFocusMenu = (0, import_react90.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react90.useRef)(/* @__PURE__ */ new Set([]));
  useUnmountEffect2(() => {
    timeoutIds.current.forEach((id2) => clearTimeout(id2));
    timeoutIds.current.clear();
  });
  const openAndFocusFirstItem = (0, import_react90.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react90.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react90.useCallback)(() => {
    var _a2, _b;
  ...
  const rafId = (0, import_react90.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react90.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id = `${menuId}-menuitem-${(0, import_react90.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled2 && !isFocusable2
  });
  const onMouseEnter = (0, import_react90.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react90.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react90.useCallback)(
    (event) => {
...
var Menu = (props) => {
  ...
  const context = (0, import_react91.useMemo)(() => ctx, [ctx]);
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react95.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react96.useRef)(null);
  const overlayRef = (0, import_react96.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react96.useRef)(null);
  const onMouseDown = (0, import_react96.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react96.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react96.useState)(false);
  const getDialogProps = (0, import_react96.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react96.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react96.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useSpinner(increment, decrement) {
  ...
  const stop2 = (0, import_react102.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const parse3 = (0, import_react103.useCallback)(
    (value) => {
      var _a2;
...
function usePinInput(props = {}) {
  ...
  const [moveFocus, setMoveFocus] = (0, import_react105.useState)(true);
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react106.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  ...
  return (0, import_react107.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const openTimeout = (0, import_react108.useRef)();
  const closeTimeout = (0, import_react108.useRef)();
...
function PopoverAnchor(props) {
  ...
  return (0, import_react109.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const focus2 = (0, import_react110.useCallback)(() => {
  ...
  const getRadioProps = (0, import_react110.useCallback)(
    (props2 = {}, ref2 = null) => {
      const checkedKey = isNative ? "checked" : "isChecked";
      return {
        ...props2,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react112.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react112.useState)(false);
  const [isFocused, setFocused] = (0, import_react112.useState)(false);
  const [isHovered, setHovering] = (0, import_react112.useState)(false);
  const [isActive, setActive] = (0, import_react112.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react112.useState)(Boolean(defaultChecked));
  ...
  const onKeyUp = (0, import_react112.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react113.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime134.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react113.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react114.useRef)(true);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react118.useLayoutEffect : import_react118.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react118.useState)([]);
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const containerStyles = (0, import_react122.useMemo)(
    () => ({
      display: "inline-block",
      position: "relative",
      verticalAlign: "middle",
  ...
  const trackStyles = (0, import_react122.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react122.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing,
      ...styles.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react123.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index) => (0, import_react123.createElement)(
      TabPanelProvider,
      {
        key: index,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react123.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react123.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react123.useState)(false);
  useSafeLayoutEffect(() => {
...
var Tabs = forwardRef(function Tabs2(props, ref) {
  ...
  const context = (0, import_react124.useMemo)(() => ctx, [ctx]);
